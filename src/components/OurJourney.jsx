      ...
      <div className="max-w-6xl mx-auto px-4 py-8 sm:py-12 md:py-16">
        ...
        <div className="mb-8 sm:mb-12 md:mb-16 bg-gradient-to-br from-orange-50 to-amber-50 p-4 sm:p-6 md:p-8 rounded-xl md:rounded-2xl shadow-md">
          ...
          <p className="text-gray-700 leading-relaxed text-lg">
            Our traditional recipes are carried forward through generations for making the savouries and sweets by captivating several loyal customers for over a century. We have proven ourselves over time by consistently providing the quality and taste of our sweets and snacks online. We serve a splendid and uncompromised quality of products with every order. That is how we grew into worldwide fame by providing quality and taste to our customers.
          </p>
        </div>

        {/* We Indulge in Offering */}
        <div className="bg-white border-l-4 border-[#FF6B35] pl-8 py-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#6B3410]">We Indulge in Offering</h2>
          </div>
          <p className="text-gray-700 leading-relaxed text-lg">
            We are committed to delivering the best quality savoury that tempt people with the promise to please even those with the most selective taste, ensuring the same great flavor for customers, every time they buy from us.
          </p>
        </div>
        ...
        <div className="mt-8 sm:mt-12 md:mt-16 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <div className="text-center p-4 sm:p-5 md:p-6 bg-gradient-to-br from-orange-50 to-white rounded-lg sm:rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-bold text-[#6B3410] mb-2">Quality Assured</h3>
            <p className="text-gray-600">Premium ingredients & traditional methods</p>
          </div>
          ...
          <div className="text-center p-6 bg-gradient-to-br from-orange-50 to-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-bold text-[#6B3410] mb-2">Doorstep Delivery</h3>
            <p className="text-gray-600">Fresh products delivered to your home</p>
          </div>
          ...
          <div className="text-center p-6 bg-gradient-to-br from-orange-50 to-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-bold text-[#6B3410] mb-2">Heritage Since 1914</h3>
            <p className="text-gray-600">Over a century of excellence</p>
          </div>
        </div>
      </div>
    </section>
