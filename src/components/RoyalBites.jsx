...
function RoyalBites() {
  ...
  const products = [
    ...
    {
      id: 2,
      name: "Smashed Peanut Chikki Bites",
      image: "https://images.unsplash.com/photo-1599599810769-bcde5a160d32?w=600&h=600&fit=crop",
      price: 70.00,
      rating: 4,
      reviews: 13
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1599599809746-d3861c1855e5?w=600&h=600&fit=crop",
      price: 80.00,
      rating: 4,
      reviews: 21
    },
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            Indulge in the elegant taste of classic sweetness.
          </p>
        </div>
          ...
          <div className="flex gap-6 overflow-hidden">
            ...
            <div className="flex-shrink-0 w-full sm:w-1/2 lg:w-1/6 bg-gradient-to-br from-gray-700 to-gray-800 rounded-lg overflow-hidden shadow-lg relative">
              <div className="absolute inset-0 opacity-10">
                <img 
                  src="https://images.unsplash.com/photo-1599599810769-bcde5a160d32?w=600&h=600&fit=crop"
                  alt="Background"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="relative z-10 p-8 h-full flex flex-col justify-center text-white">
                <h3 className="text-3xl font-bold mb-4">Chikki</h3>
                <p className="text-sm mb-6 leading-relaxed">
                  Nutty, crunchy, and delightfully nostalgic
                </p>
              ...
              <div key={product.id} className="flex-shrink-0 w-full sm:w-1/2 lg:w-1/6">
                <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 h-full">
                  ...
                  <div className="relative h-64 overflow-hidden group">
                    ...
                    {/* Decorative elements on specific cards */}
                    {index === 0 && (
