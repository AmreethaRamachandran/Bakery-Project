  ...
  return (
    ...
    >
      ...
      <div className="bg-[#fff8e8] p-6 sm:p-8 rounded-3xl shadow-2xl w-full max-w-md 
        ...
        />
       <Link to="/" className="w-full bg-gradient-to-r from-[#c96c04] to-[#e88c14] text-white py-3 rounded-xl text-sm font-semibold hover:brightness-110 transition-all shadow-md text-center block">REGISTER</Link>
        <p className="text-center mt-5 text-sm text-[#4a3d2a]">
          Already have an account?{" "}
          <Link to="/login" className="text-[#d97706] font-semibold cursor-pointer hover:underline">
            Login here
          </Link>
        </p>
